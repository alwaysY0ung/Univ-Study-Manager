    ...
    public TodaySchedule() {
        ...
        timeTableButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // 시간표 팝업 창 구현
                JDialog timeTableDialog = new JDialog((JFrame) SwingUtilities.getWindowAncestor(TodaySchedule.this), "시간표", true);
                timeTableDialog.setSize(400, 300);
                timeTableDialog.setLocationRelativeTo(TodaySchedule.this);
